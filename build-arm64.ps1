...
$ErrorActionPreference = "Stop"
docker run -d --platform linux/arm64 --name temp-edge-eo ghcr.io/euro-office/documentserver:latest
...
wsl bash -c "cd /tmp/edge-release && zip -ry /mnt/d/eurooffice-blackbox/eurooffice-edge-arm64.zip ."
...
Write-Host "Done! D:\eurooffice-blackbox\eurooffice-edge-arm64.zip successfully created."
